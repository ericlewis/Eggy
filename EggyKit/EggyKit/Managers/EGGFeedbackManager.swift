...
#if os(watchOS)
public struct EGGFeedbackManager: EGGFeedbackManagerActionsProtocol, EGGSingletonProtocol {
  static var shared: EGGFeedbackManager = EGGFeedbackManager()
...
public struct EGGFeedbackManager: EGGFeedbackManagerProtocol, EGGFeedbackManagerActionsProtocol, EGGSingletonProtocol {
  public static var shared: EGGFeedbackManager = EGGFeedbackManager()
