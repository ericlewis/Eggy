...
public struct EGGNotificationScheduler: EGGNotificationSchedulerProtocol {
    ...
    public init(settingsManager: EGGSettingsProtocol = EGGSettings(),
                doneNotice: EGGLocalNotification = EGGEggFinishedNotification(),
                warningNotice: EGGLocalNotification? = EGGEggThirtySecondsRemainingNotification()) {
