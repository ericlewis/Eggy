...
class EGGLocalNotificationTests: XCTestCase {
    ...
    override func setUp() {
        ...
        subject = EGGLocalNotification(title: "Hello",
                                       message: "World",
    ...
    func testHasCorrectTrigger() {
      if let timeIntervalTrigger = createdNotificationRequest.trigger as? UNTimeIntervalNotificationTrigger {
    ...
    func testDoesntFireWithoutTitle() {
        ...
        let subject = EGGLocalNotification(title: "Hello",
                                           message: "World",
                                           userNotificationCenter: fakeUserNotificationCenter)
...
class EGGEgg30sRemainingNotificationTests: XCTestCase {
    var fakeUserNotificationCenter: FakeUNUserNotificationCenter!
