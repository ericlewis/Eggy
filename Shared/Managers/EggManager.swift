...
class EggManager: EasyBindableObject, FormattersProtocol, EggStateProtocol, CookTimeProtocol, LocalNotificationsProtocol, ViewModelProtocol, BoilingPointManagerProtocolDelegate, EggDefaultsProtocol {
    ...
    @Cloud("doneness", defaultValue: EggManager.eggDefaults.doneness) var doneness: Doneness {didSet {changed()}}

    @Cloud("size", defaultValue: EggManager.eggDefaults.size) var size: Size {didSet {changed()}}

    @Cloud("boilingPoint", defaultValue: EggManager.eggDefaults.boilingPoint) var boilingPoint: BoilingPoint {didSet {changed()}}
